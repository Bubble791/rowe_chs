...
#define GYM_SECOND_TM_BADGES_COUNT 0
#define GYM_THIRD_TM_BADGES_COUNT 1
#define GYM_FOURTH_TM_BADGES_COUNT 2
#define GYM_FIFTH_TM_BADGES_COUNT 3
#define GYM_MEGA_STONES_BADGES_COUNT 4
