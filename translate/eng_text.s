...
GraniteCave_1F_Text_GetsDarkAheadHereYouGo:
    .org 0x828d0ff
    .area 299
    .strn "嘿,你。\l这个洞穴里隐藏着很多\n强大的岩石属性宝可梦。\p之前路过的那家伙……\n我想他叫大吾。\p他懂得使用钢系招式,\n所以他应该没问题的。\p嗯,\n对于我们徒步旅行者来\p说,\n帮助路上遇到的人是我\p们的信条。来,\n这个给你,\p我就把这个交给你了。$"                                                                                                                                                                            
    .endarea
...
Game_Start_Text_Game_Modes_Double_Battle_Info:
    .org 0x829baa0
    .area 159
    .strn "只要你有2个可以战斗\n的宝可梦,\p这将使每一场战斗都成\n为双打对战。\p此模式{COLOR GREEN}稍后可以在凯\n那市启用或禁用{COLOR DARK_GRAY}。$"                                                                                                 
    .endarea
...
Game_Start_Text_Game_Modes_Randomized_Party_Info:
    .org 0x829c0e6
    .area 179
    .strn "这将改变每一个训练师\n和野生宝可梦,\p让另一个随机物种在每\n次战斗前加入你的队伍。\p这{COLOR RED}可能会导致每次战\n斗{COLOR DARK_GRAY}前的加载时间更长。$"                                                                                                            
    .endarea
...
Route114_FossilManiacsTunnel_Text_NotSafeThatWay:
    .org 0x828a1a8
    .area 173
    .strn "哦……那样走不安全…\n…我当时正在挖,\p你知道吗……突然整面\n墙都塌了……我想下面现在有个巨大的洞穴……你可能会在那里找到一些稀有的宝可梦……$"                                                                                                        
    .endarea
...
Route117_PokemonDayCare_Text_NoRoomForThis:
    .org 0x828adf4
    .area 63
    .strn "哦？\n你的宝可梦太多了。\p没有地方放这个宝可梦\n了！$"                                 
    .endarea

Route117_PokemonDayCare_DittoWoman_Text_2:
    .org 0x828afe0
    .area 284
    .strn "我这里有一只稀有的宝\n可梦,\p是有人忘在培育屋这里\n的,因为没人领养,\p所以我现在先养着。\p可惜我不是训练师,\n没法帮它变得更强。\p你是训练师对吧？\n我看到你的宝可梦充满\p了生命力。那么,\n你怎么说？\n你能收养这只百变怪吗？$"                                                                                                                                                                      
    .endarea
...
SlateportCity_Harbor_EventScript_CaptSternPory_Text_0:
    .org 0x826a914
    .area 154
    .strn "楠木馆长:哦？{PLAYER},\n你手上的那个东西……\n那是个扫描仪！\p那肯定会对我们的探险\n有很大帮助。{PLAYER},\p你愿意用你的扫描仪来\p交换一些东西吗？$"                                                                                
    .endarea
...
SlateportCity_NameRatersHouse_Text_PleasedToRateMonNickname_Disable:
    .org 0x8266a9b
    .area 163
    .strn "嗨,嗨！\n我是名字评定员！\n……或者说,\p我以前是。\n现在你可以在每一个宝\p可梦中心评定昵称了……但是呢,\n我现在还可以关闭双打\p对战模式哦,怎么样？$"                                                                                    
    .endarea
...
VictoryRoad_1F_Text_WallyPostBattle:
    .org 0x82956e1
    .area 129
    .strn "满充:这次我也赢不了\n你,但总有一天,\p{PLAYER},我会赶上你的,\p打败宝可梦联盟！$"                                                                                        
    .endarea

ViridianCity_Text_CanCarryMonsAnywhere:
    .org 0x834381f
    .area 126
    .strn "你腰上的那些精灵球！\n你有宝可梦,是吗？\p你可以随时随地携带和\p使用宝可梦,\n这真是太棒了。$"                                                                             
    .endarea
...
Common_EventScript_Colress_First_Encounter_Text_0:
    .org 0x82d99c2
    .area 274
    .strn "哦,抱歉打扰！\n我是一名科学家,\n我叫阿克罗玛。\p我的研究重点是物种间\n的地域差异。例如,\p关东地区的九尾与阿罗\p拉地区的九尾就有着不同的种族和样貌。\n似乎七之岛这里也在发\p生着类似的现象。$"                                                                                                                                                                                
    .endarea
...
MauvilleCity_Gym_Text_WattsonIntro_New:
    .org 0x82e59f6
    .area 297
    .strn "什么？\n你说你已经通过了我设\p置的所有机关？\n哇哈哈哈！这真有趣！\p关于重建紫堇市的计划,\p现在先放一放。\n为我的道馆设置机关,\p并与像你这样的年轻训\n练师对战,\p这就是我现在的生活乐\n趣！那么,\p我,铁旋,\p紫堇市道馆的馆主,\p就要用电击来招待你了！$"                                                                                                                                                                   
    .endarea
...
MauvilleCity_Gym_EventScript_Wattson_Give_Gifts_Text_3:
    .org 0x82e17cb
    .area 175
    .strn "铁旋:这是一个专为高\n物理攻击的电系宝可梦设计的电系伤害招式,\p它也会对使用者造成反\n伤,\p所以要明智地使用它。$"                                                                                                                     
    .endarea
...
SootopolisCity_Gym_1F_Text_JuanIntro:
    .org 0x82840bc
    .area 362
    .strn "欢迎挑战者,\n我是亚当,\p是琉璃市道馆的馆主。\n我曾经把我的馆主让给\p了我的徒弟,但是,\n因为一个强有力的理由\n而复出了。啊,\p不过闲话少说。\p让我们开始比赛吧,\n好吗？\p请你见证一下我们的技\n巧。\p这是由宝可梦和我共同\n创造的伟大水之幻象！$"                                                                                                                                                                                                                                             
    .endarea
...
Common_Eventscript_Gym_Leader_Falkner_Text_5:
    .org 0x82e3738
    .area 233
    .strn "我是阿速,\n这个岛屿的宝可梦道馆\p馆主！\n人们说可以用电击来剪\p断飞行系宝可梦的翅膀……我不会允许这样的侮辱落在鸟类宝可梦身上！\n我要让你见识一下真正\p的华丽鸟类宝可梦的力量！$"                                                                                                                                               
    .endarea
...
Common_Eventscript_Gym_Leader_Whitney_Text_6:
    .org 0x82e3f9d
    .area 129
    .strn "……嗅嗅……什么？\n你想要什么？徽章吗？\p哦,对了。\p我忘了。\p这是常规徽章。徽章,\n对于像我这么可爱的人\n来说,不是正合适吗？$"                                                            
    .endarea
...
MoveTutor_MimicTeach:
    .org 0x83407d5
    .area 231
    .strn "啊,年轻人！\n其实我也是个年轻人,\n但我模仿了这个镇子上\p老年人的风格和说话方式。\n你说呢,年轻人？\p如果我用模仿这个招式\p来和你交换一个心之鳞片,\n你愿意吗？$"                                                                                                                                                     
    .endarea
...
MoveTutor_Text_DynamicPunchTeach:
    .org 0x8340f2a
    .area 332
    .strn "我不能再这样下去了！\n这简直太失败了！\p我是个格斗系训练师,\n但是无论我怎么努力,\p都无法在战斗帐篷中获\n胜！啊！\p打！打！\p打！打！\p打！打！\p哎,别那样看着我！\p我只是在打地面！\p或者,\n你想让我教你的宝可梦\p学会爆裂拳这个招式吗？\n用一个心之鳞片来换。$"                                                                                                                                                                                                      
    .endarea
...
MysteryEventClub_Text_EasyChatExplanation:
    .org 0x830a8a0
    .area 576
    .strn "你可以通过组合四个单\n词或短语来创建自己的资料。\p来,\n我给你看一个用四段文\p字组成的资料的例子。\n你可以随意用其他文字\p段落替换这四个段落,\n以创建你自己的资料。\p有很多文字段落供你使\n用。\p它们被分成宝可梦、生\n活方式和爱好等类别,\p这样查找起来更方便。\n所以,首先,\p选择一个文字段落的类\p别以显示选择列表。\n然后,\p选择你想要的那个。\n对剩下的文字选择重复\p此操作,\n你将拥有你自己的资料。$"                                                                                                                                                                                                                                                                                                                                                                                   
    .endarea
...
Text_IVChecker_2:
    .org 0x82eb540
    .area 51
    .strn "你的宝可梦的个体值如\n下:HP:{STR_VAR_1},\p攻击:{STR_VAR_2},防御:{STR_VAR_3}$"                 
    .endarea

Text_IVChecker_3:
    .org 0x82eb573
    .area 51
    .strn "特攻:{STR_VAR_1},特防:{STR_VAR_2},\n速度:{STR_VAR_3}$"                               
    .endarea
...
Common_PkmnCenterJack_Text_MonHasForgottenMove:
    .org 0x82eb468
    .area 57
    .strn "它完美无缺地发挥了作\n用！\p{STR_VAR_1}已经完全忘记了{STR_VAR_2}。$"                             
    .endarea
...
SevenIsland_EventScript_OldWoman_Text_0:
    .org 0x82e9ae9
    .area 215
    .strn "这些岛屿被称为七岛,\n因为有七个岛屿。\p……或者至少年轻人是\n这样认为的。事实上,\p这些岛屿之所以得名,\p是因为据说它们是在七\n天之内形成的。$"                                                                                                                                             
    .endarea
...
UDTrade_Text_ItemNotAllowed:
    .org 0x8342f56
    .area 55
    .strn "对不起,\n{STR_VAR_1}不能携带持有物品进\p入{STR_VAR_2}。$"                               
    .endarea
